About snownlp-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/snownlp-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13805&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/snownlp-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `snownlp` can be installed with `conda`:
...
```
mamba install snownlp
```

It is possible to list all of the versions of `snownlp` available on your platform with `conda`:
...
```
mamba search snownlp --channel conda-forge
```
...
mamba repoquery search snownlp --channel conda-forge

# List packages depending on `snownlp`:
mamba repoquery whoneeds snownlp --channel conda-forge

# List dependencies of `snownlp`:
mamba repoquery depends snownlp --channel conda-forge
```
